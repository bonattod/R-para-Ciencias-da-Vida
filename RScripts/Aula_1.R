...
pacotes_cran <- c("tidyverse",   # Conjunto de pacotes para manipulação e visualização de dados
                  ...
                  "vegan")       # Análises ecológicas, como índices de diversidade
...
pacotes_bioconductor <- c("DESeq2",       # Análise diferencial de expressão para RNA-Seq
                          "edgeR",        # Análise estatística de dados de RNA-Seq
                          "Biostrings",   # Manipulação de sequências biológicas
                          "phyloseq",     # Análise de microbiomas e dados filogenéticos
...
# Instala pacotes do GitHub para manipulação e visualização de árvores filogenéticas
remotes::install_github("GuangchuangYu/treeio")  # Pacote para manipular árvores filogenéticas
remotes::install_github("GuangchuangYu/ggtree")  # Pacote para visualizar árvores filogenéticas
